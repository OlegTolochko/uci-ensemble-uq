...
def pipeline(data_path="data/iris/iris.data", test_size=0.3, ensemble_size=10, random_state=42):
    ...
    sampled_labels = sample_labels(probs_train, ensemble_size=ensemble_size, random_state=random_state)
